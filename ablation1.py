...
ABLATION1_CONFIGS = {
    ...
    "no_epistemic": {
        "label":       "SENZA EPISTEMIC VALUE",
        "description": "EFE senza termine epistemico — maintain vince sempre",
        "flaw":        "EFE(slow)=Risk+0.4 > EFE(maintain)=Risk+0.1 sempre",
        "belief_cls":  BeliefState,
        "epistemic":   False,
    },
    "no_threshold": {
        "label":       "SENZA ANOMALY THRESHOLD",
        "description": "Belief sempre TRUST_SENSOR — anomalia mai rilevata",
        "flaw":        "threshold disabilitata; uncertainty bassa; epistemic≈0",
        "belief_cls":  NoThresholdBeliefState,
        "epistemic":   True,
    },
    "no_uncertainty": {
        "label":       "SENZA UNCERTAINTY",
        "description": "Uncertainty sempre 0.1 — epistemic value troppo basso",
        "flaw":        "uncertainty=0.1 → epistemic=0.1 → maintain sempre vince",
    ...
    "no_model": {
        ...
        "flaw":        "expected=0 → durante attacco pred_error≈0 → nessuna anomalia",
